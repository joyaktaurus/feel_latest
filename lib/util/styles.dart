...
Color GreenTop = const Color(0xFF33cdde);
Color GreenBottom = const Color(0xFF028b9b);
Color GreenLoh = const Color(0xFFd5f2f6);
Color GreenHi = const Color(0xff6b888a).withOpacity(0.5);
Color LightGrey = const Color(0xBDBDBDFF).withOpacity(0.1);
